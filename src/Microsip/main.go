...
func isValidDocument(doc string) bool {
	// Implemente aqui a lógica para verificar se a entrada é válida
	// Por exemplo, você pode verificar o formato esperado do documento
	// e retornar true se for válido, ou false se for inválido.
	// Aqui, estou apenas verificando se a entrada não está vazia como exemplo.

	if doc == "" {
		fmt.Println("doc vazio")
		return false
	}
